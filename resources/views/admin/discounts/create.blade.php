...
@section('content')
    <div class="col-lg-10 offset-lg-1 mb-5">
        ...
        <form class="w-100" method="POST" action="{{action('AdminDiscountsController@store')}}">
            ...
            <div class="card mb-2">
                ...
                <div class="p-2">
                    ...
                    <div class="form-group position-relative mb-3">
                        <input type="text" class="owninput" name="description"><span class="highlight"></span><span class="bar"></span>
                        <label class="ownlabel">Description</label>
                    </div>
                    <div class="form-group position-relative mb-3">
                        <input type="number" min="1" max="100" class="owninput" name="percent"><span class="highlight"></span><span
                            class="bar"></span>
